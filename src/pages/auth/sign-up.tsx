                    ...
                    <div className="flex flex-col gap-2 text-center">
                        ...
                        <form onSubmit={handleSubmit(handleSignUp)} className="space-y-6 mt-4">
                            <div className="space-y-2">
                                <Label htmlFor="restaurantName"><strong>Nome do estabelecimento</strong></Label>
                                <Input id="restaurantName" type="text" {...register('restaurantName')} />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="managerName"><strong>Seu nome</strong></Label>
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="phone"><strong>Seu celular</strong></Label>
